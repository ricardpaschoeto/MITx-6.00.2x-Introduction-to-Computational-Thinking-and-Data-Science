...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        """
        #random.seed(0)
        rx = range(0, self.width)
        ry = range(0, self.height)
        
        return Position(random.choice(rx),random.choice(ry))
        #raise NotImplementedError
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.robot_dir = random.randint(0,360)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        new_pos = pos.getNewPosition(angle, speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    minNumCleanTiles = total_tiles*min_coverage
    for ii in range(num_robots):
        robot = robot_type(room, speed)
        robots.append(robot)
    #anim = ps2_visualize.RobotVisualization(num_robots, width, height)
    for ii in range(num_trials):
        while (cleaned < minNumCleanTiles):
            for robot in robots:            
...
#print(runSimulation(2, 3.0, 15, 13, 0.98, 30, RandomWalkRobot))
...
#     plot.
#
showPlot1('Robots time average', 'num of robots', 'Times')
#
...
#     plot.
#
showPlot2('Robots Shape average', 'Shapes', 'Times')      
#
# room = RectangularRoom(5, 5)
# for ii in range(0,10):
#     pos = Position(ii*random.random(), ii**random.random())
#     print(pos)
